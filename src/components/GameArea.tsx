...
export const GameArea = ({ characters, onReachBase }: GameAreaProps) => {
  return (
    <div className="relative bg-gradient-to-b from-sky-300 to-sky-100 rounded-lg md:rounded-xl p-3 md:p-4 shadow-lg border border-primary/30 flex-1 min-h-0 overflow-hidden">
      {/* Clouds decoration */}
